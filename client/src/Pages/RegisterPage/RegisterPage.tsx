          ...
          <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 sm:p-8'>
            <div className='text-center mb-8'>
              ...
              <p className='text-sm text-gray-600 dark:text-gray-400 font-light'>
                Create your account for unlimited downloads
              </p>
            </div>
            ...
            <form className='space-y-6' onSubmit={handleSubmit}>
              ...
              <div>
                <button
                  type='submit'
                  disabled={isLoading}
                  className='w-full px-6 py-1 sm:py-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-lg sm:rounded-xl disabled:from-gray-400 disabled:to-gray-500 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center gap-2 font-medium shadow-lg hover:shadow-xl transform hover:scale-[1.01] disabled:transform-none'
                >
